...
var switchAboutToActive = function () {
  ...
  // Add 'active' to About menu button if not already there
...
// Returns a random from 1 to 5 (inclusive)
...
// Builds HTML for the About page with a randomly generated
// star rating
function buildAndShowAboutHTML () {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (aboutHtml) {
      ...
      // Generate random rating between 1 and 5 (inclusive)
      var rating = chooseRandomRating();

      // Add appropriate classes to each span to display stars
      ...
      // Bonus: Replace "{{rating}}" with rating value
